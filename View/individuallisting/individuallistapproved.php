<div class="right_aside_main">
     ...
     <div class="button_section">
    	<div class="create_new_enquiry">
			<a class="locality" style="background:#6a1abb;">Approved</a>
			<a class="add_prop" style="background:#1abb57;" href="<?php echo base_url();?>individuallistadmin/individuallist">New Requests</a>
			<a class="locality" style="background:#1abb57;" href="<?php echo base_url();?>individuallistadmin/individuallistrejected">Rejected</a>
        </div>
    </div>
    ...
    <div class="sri_table_main">
        ...
        <div class="body_info body_info_prprty locality_list_body">
            ...
            <a class="viewclass" href="<?php echo base_url();?>individuallistadmin/edit_individuallist?propId=<?=$val->property_IDPK?>">View</a>
            </div>
        </div>
        <?php 
        $counter++;
